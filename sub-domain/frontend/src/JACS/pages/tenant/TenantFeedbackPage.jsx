...
import { Loader2, MessageSquare, AlertTriangle, CheckCircle, Clock, Filter, Search, Plus, Eye, X, Star, FileText, Send } from 'lucide-react';
...
const TenantFeedbackPage = () => {
  ...
  const filteredFeedback = feedback.filter(item => {
    ...
    const matchesType = typeFilter === 'all' || (item.feedback_type || '').toLowerCase() === typeFilter.toLowerCase();
  ...
  const complaintsCount = feedback.filter(f => (f.feedback_type || '').toLowerCase() === 'complaint').length;
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">Share your feedback, complaints, or suggestions with us</p>
            </div>
            <button
            ...
            <div className="divide-y divide-gray-100">
              {filteredFeedback.length === 0 ? (
                <div className="px-6 py-12 text-center">
                  ...
                  <p className="text-sm text-gray-500">Submit your first feedback or complaint to get started</p>
                </div>
              ) : (
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 mt-1">
                              <span className="text-sm text-gray-500">
                                {getTypeDisplay(item.feedback_type)}
                              </span>
                              {item.rating && (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 mt-1">
                    <span className="text-sm text-gray-600">
                      {getTypeDisplay(selectedFeedback.feedback_type)}
                    </span>
